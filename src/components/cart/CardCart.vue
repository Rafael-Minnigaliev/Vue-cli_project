<template>
  <div class="product-cart">
    <picture class="product-cart__picture">
      <source
    ...
    <div class="product-cart__info">
      ...
      <form action="#" class="product-cart__quantity-form">
        ...
        Size: Xl <br />
        Quantity:<input
          class="product-cart__quantity-input"
          type="number"
          name="quantity"
          min="1"
          max="10"
    ...
    <button v-on:click="deleteCartGood" class="product-cart__close">
...
export default {
  ...
  data() {
    return {
      newValue: this.good.quantity,
    };
  },
  methods: {
    deleteCartGood() {
      this.$store.dispatch("deleteFromCart", this.good);
    },
    changeQuantity() {
      const good = this.good;
      good.quantity = this.newValue;
      this.$store.dispatch("changeQuantity", good);
    },
  },
};
</script>